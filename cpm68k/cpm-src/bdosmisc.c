...
/* Initialize the File System */
{
    ...
    /* Type-ahead buffer preserved across warm boot;    */
    /* cleared by tbuf_init() on cold boot only.        */
    GBL.delim  = '$';
    GBL.lstecho = FALSE;
    GBL.echodel = TRUE;
    GBL.chainp  = NULL;
    ...
    tpa_ht = tpa_hp = segp->low + segp->length;
    initexc( &(GBL.excvec[0]) );
}

/********************************
*  Type-ahead buffer init	*
*  Called on cold boot only	*
********************************/
