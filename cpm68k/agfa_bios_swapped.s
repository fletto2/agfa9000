 ...
 *
 * RAM layout (2MB at 0x02000000-0x021FFFFF):
 ...
 *   0x02050000-0x021EFFFF  TPA (~1.6MB)
 *   0x021F0000-0x021FFFFF  Supervisor stack (64KB)
 *
 ...
 *==========================================================================*/
    ...
    /* RAM addresses (2MB: 0x02000000-0x021FFFFF) */
    ...
    .equ TPA_END,       0x021F0000  /* TPA ends here (~1.6MB) */
    .equ SSP_TOP,       0x02200000  /* Supervisor stack top (end of 2MB) */
...
banner:
    .ascii  "\r\n\r\n"
    .ascii  "Agfa CP/M-68K v1.5\r\n"
    .asciz  "Z8530 Channel A (RS-422), 9600 8N1\r\n\r\n"
